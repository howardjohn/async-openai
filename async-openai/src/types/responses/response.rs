...
pub struct FunctionToolParam {
    ...
    /// Whether the tool result can be returned asynchronously in a later response.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub enum Item {
    ...
    /// Updates the response configuration used by subsequent turns.
...
pub struct CompactionTriggerItemParam {
    /// The unique ID of the compaction trigger item.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[serde(rename = "type")]
...
/// Reasoning settings applied by a conversation configuration update.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Default)]
...
/// An input item that changes response configuration for subsequent turns.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Default)]
...
/// A response configuration update returned as a conversation item.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq)]
...
pub struct CreateResponse {
    ...
    /// Model ID used to generate the response, like `gpt-6-astra` or `gpt-5`. OpenAI
...
pub struct WebSearchTool {
    ...
    /// Whether the search may access the public web outside OpenAI-controlled sources.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct ErrorObject {
    ...
    pub message: String,
    /// Details about a misalignment policy violation, when present.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub misalignment: Option<serde_json::Value>,
}
...
pub struct FunctionToolCall {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<OutputStatus>,
    /// Whether this function call is running asynchronously.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub r#async: Option<bool>,
}
...
pub struct MCPToolCall {
    ...
    /// Error details from the call, if any.
...
/// An error returned by an MCP tool call.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq)]
#[serde(untagged)]
pub enum MCPToolCallError {
    Structured(MCPToolCallErrorDetails),
    /// Compatibility with responses produced before structured MCP errors were introduced.
    Message(String),
}
...
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq)]
#[serde(tag = "type", rename_all = "snake_case")]
pub enum MCPToolCallErrorDetails {
    McpProtocolError { code: i64, message: String },
    McpToolExecutionError { content: serde_json::Value },
...
pub struct Response {
    ...
    /// Model ID used to generate the response, like `gpt-6-astra` or `gpt-5`. OpenAI offers a
    ...
    /// Diagnostics explaining whether the requested prompt-cache comparison was reusable.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct CustomToolCall {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub caller: Option<ToolCallCaller>,
    /// Whether this custom tool call is running asynchronously.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub r#async: Option<bool>,
}
...
/// Why a prompt-cache comparison did not reuse the cached prefix.
#[derive(Debug, Serialize, Deserialize, Clone, Copy, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
...
/// Prompt-cache comparison diagnostics returned with a response.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Eq)]
#[serde(tag = "type", rename_all = "snake_case")]
...
pub struct CompactResponseRequest {
    /// Model ID used to generate the response, like `gpt-6-astra` or `gpt-5`. OpenAI offers a wide range of models
